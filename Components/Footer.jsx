...
const Footer = () => {
  return (
    <footer className="pt-8 bg-custom-black ml-14 mr-14 rounded-md flex flex-col justify-center items-center" id="contacts">
      <Image src={logo} width={300} height={300} alt="Company logo" />
      <div className="flex flex-row justify-between w-full pt-8 pl-8 pr-32">
        <div>
        ...
        <div>
          ...
          <p className="text-white pt-2 pl-2">Mumbai, India</p>
        </div>
        <div>
          <div className="flex flex-row">
